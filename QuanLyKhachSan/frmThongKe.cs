    ...
    public partial class frmThongKe : Form
    {
        ...
        private void UpdatePieChart(decimal doanhThuPhong, decimal doanhThuDichVu)
        {
            try
            {
                ...
                if (total > 0)
                {
                    // Thêm dữ liệu và cấu hình cho từng điểm
                    series.Points.AddXY("Doanh thu phòng", (double)doanhThuPhong);
                    series.Points[series.Points.Count - 1].Color = Color.FromArgb(255, 128, 128);
                    series.Points[series.Points.Count - 1].LabelForeColor = Color.White;

                    series.Points.AddXY("Doanh thu dịch vụ", (double)doanhThuDichVu);
                    series.Points[series.Points.Count - 1].Color = Color.FromArgb(128, 255, 128);
                    series.Points[series.Points.Count - 1].LabelForeColor = Color.White;
                }
                else
                {
        ...
        private void UpdateLineChart(int year)
        {
            try
            {
                ...
                var series1 = new Series("Doanh thu phòng")
                {
                    ...
                    BorderWidth = 3,
                    Color = Color.FromArgb(255, 128, 128), // Màu đỏ nhạt như roundedPanel1
                ...
                var series2 = new Series("Doanh thu DV")
                {
                    ChartType = SeriesChartType.Line,
                    BorderWidth = 3,
                    Color = Color.FromArgb(128, 255, 128), // Màu xanh lá như roundedPanel2
                    MarkerStyle = MarkerStyle.Circle,
                    MarkerSize = 8
                };
                ...
                var series3 = new Series("Tổng doanh thu")
                {
                    ChartType = SeriesChartType.Line,
                    BorderWidth = 3,
                    Color = Color.FromArgb(128, 128, 255), // Màu xanh dương như roundedPanel3
                    MarkerStyle = MarkerStyle.Circle,
                    MarkerSize = 8
                };
